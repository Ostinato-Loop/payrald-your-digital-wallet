  ...
  return (
    <Screen title="Receive money" subtitle="Share any of your ALIA identities">
      <div className="surface-card flex flex-col items-center gap-4 px-6 py-8 text-center">
        ...
        <button
          onClick={() => {
            navigator.share?.({ title: "Pay me on PayRald", text: handle }).catch(() => {});
          }}
          className="tap inline-flex items-center gap-2 rounded-full bg-primary px-5 py-2.5 text-xs font-semibold text-primary-foreground shadow-glow-red"
        >
      ...
      <p className="px-2 text-center text-xs text-muted-foreground">
        No account numbers required. ALIA routes funds to your wallet
        automatically.
      </p>
    </Screen>
  );
